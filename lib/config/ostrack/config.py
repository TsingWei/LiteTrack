...
cfg.MODEL.BACKBONE.SEP_LOC = []
# MODEL.HEAD
cfg.MODEL.HEAD = edict()
cfg.MODEL.HEAD.TYPE = "CENTER"
cfg.MODEL.HEAD.NUM_CHANNELS = 768
cfg.MODEL.HEAD.NUM_QUERIES = 30
cfg.MODEL.HEAD.NUM_LAYERS = 2
cfg.MODEL.HEAD.ATTN = 'SELF'
cfg.MODEL.HEAD.CLASSIFICATION_POSITION = 'FFN'
